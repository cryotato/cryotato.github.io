...
## Emergent Tremolo:
- Whammy Morph :: Shove the waveform back and forth with a wiggle of the lasers

## Emergent Synthesis
- Luminous Modulation & Rhythmic Gating :: The laser emitters, far from being passive illuminators, become active agents of sonic transformation. By pulsing laser emitters at audio-rate frequencies, the KitterChord Hex transcends its role as a pickup and becomes a raw synthesizer. Each laser/sensor pair transforms into an independent oscillator, its rapid on/off cycle interpreted by the sensor as a fundamental frequency. When pulsed at sub-audio rates (e.g., 1-20 Hz), they impose a rhythmic will upon the string's voice. The string's sustained note is sharply gated, chopped into percussive bursts dictated by the laser's own flashing cadence – an intrinsic tremolo or rhythmic slicing that extends the "MIDI Injected Gating" concept into a purely light-driven modulation, no external clock required.
- Audio-Rate Alchemy & Sideband Spectres :: Escalate the laser's pulse into the audio range (e.g., 50 Hz - several kHz), and the Hex fully awakens as a raw synthesizer. Here, the rapidly flashing laser generates its own audible tone – a luminous carrier wave. The vibrating string then acts as a modulator, its signal imprinting itself onto this light-born frequency. This is Amplitude Modulation (AM) synthesis realised through physical interaction. The resulting sonic tapestry is rich and complex, containing the original string frequency, the laser's own flash-generated frequency, and crucially, a host of sideband frequencies – new spectral artifacts born from the sum and difference of the string and laser frequencies (String Hz + Laser Hz; String Hz - Laser Hz). This alchemical process forges intensely rich, often metallic, bell-like, or uniquely non-harmonic timbres, especially when the string and laser frequencies are not simple integer multiples. It's a classic synthesis technique, here emergent from the direct dance of light and string, pushing the instrument into uncharted, textured dimensions.
...
its basically a ring modulator, if theres only one laser per string the effect is basically always 100% on? unless the reflective laser is there as well and its not flashing/modulating? then the wetness can be adjusted that way
