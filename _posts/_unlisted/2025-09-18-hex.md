---
permalink: /shop/
title: "ϑ’KitterChord HEXaphotonifier 咪鬍の咒灮 ʷᵒʳˡᵈˢ ᶠⁱʳˢᵗ ᵖʰᵒᵗᵒⁿⁱᶜ ᵖⁱᶜᵏᵘᵖ⁻ˢʸⁿᵗʰ⁻ᵖⁱᶜᵏᵘᵖ"
seo_title: "KitterChord HEXaphotonifier - worlds first photonic pickup-synth"
seo_description: "The Hex is a hexaphonic lofi laser pickup that opens up new ways to manipulate sound using light"
author_profile: true
# layout: wide
toc: true
toc_label: "HEX"
...
<!-- 
NEW FINDINGS!
- pwm dimmer does not make it much quieter, but it does control the shape of the waveform and essentially the mix of tone vs guitar sound, while also effecting how intense distortions are
- emergent distortion eclipsing isnt like that anymore with newer PDs,to increase distortion you have to position the pickup higher up towards the soundhole! and for less distortion you bring it down towards the bridge. the window analogy is still true but whats changing is how far the strings are vibrating.
- eclipsing past the string creates a Rubber Bridge type effect where strums become plucky and short, kinda like adrianne lenker's fool (good cover opportunity)
- the pwm ALSO creates cool bitcrush-like distortions, as the squared pwm fluctuations can also be understood as changing sample rate
  - PWM frequency acts like a "chopper" reducing the sample rate
- also im not doing the phasing thing anymore
- and the compression,,, well i could in another version with digital pots to dim the laser but thats too much effort, doing it in post would be much easier
- also emergent rhythm can be about the rhythm gate but its not really important or ... any good at all.. unless you pair it with that landscape resonator thing maybe??? its just you have to strum all the time aggressively for it to work

the leaflet:
The Hex is a hexaphonic lofi laser pickup that opens up new ways to manipulate sound using light, creating "emergent" effects.
- emergent fuzz
    position the pickup higher up towards the soundhole! and for less distortion you bring it down towards the bridge
- emergent vibrato
    wiggle the lasers around to move the waveform
- emergent AM ring mod and bitcrush
    use the CHAOS and EMERGENT ELEMENT knobs to tweak the Amplitude Modulation alghorithm,
    EMERGENT ELEMENT  - metallic nature, frequency, intensity / subtilty
    CHAOS- crush, mix and feedback.
 -->
...
This project is currently under development.., Want to be notified on preorders? Join the waiting list!:
