...
### 寫
its bothered me for a while that 寫 (writing) doesn't contain the hand-holding-a-brush component 聿 like 書 book or 畫 draw or 筆 pen., so lets fix that real quick - 聿셰. another option would be to simplify it by replacing the top 宀臼 with 聿 and have it merge with the 勿-looking component to make it look like something is being written below the pen.
